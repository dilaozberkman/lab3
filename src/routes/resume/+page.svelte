...
and wrote ArcGIS scripts for trajectory feature calculations</li>
    ...
    <div class="cv-grid">
      <div class="cv-left">
        <h3><a href="https://www.saota.com/">SAOTA</a></h3>
        <p><em>Architecture Intern</em></p>
      </div>
      <div class="cv-right">
...
<em>In Preparation.</em></p>
  ...
  <div class="cv-grid">
    <div class="cv-left">
      <h3>Exhibition Design Assistant for Venice Biennale 2023</a></h3>
    </div>
    <div class="cv-right">
  ...
  <section>
    ...
    <ul class="skills-list">
      <li><b>Languages: </b>Turkish, English, Spanish (Beginner)</li>
      <li><b>Technical Languages: </b>Python, SQL, Julia, Java, HTML.</li>
      <li><b>Libraries: </b>PyTorch, NumPy, GeoPandas, ArcPy, Plotly, Rasterio, Shapely, OSMnx, Click.</li>
      <li><b>Software: </b>ArcGIS, QGIS, Tableau.</li>
